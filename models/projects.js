...
var Projects = new Projects([
        {
            ...
            description: '<p>Development server is available here: <a href="http://23.23.193.121:8888/" target="_blank">devserver</a>. <br/>Username: admin, Pass: admin.</p><p>Lionface is a startup focused primary on nonprofit organizations and social interactions. This project is a result of 9 months work in collaboration with Nick Clark as a designer and a founder.</p><p>Server code is written in python with the help of the <a href="https://www.djangoproject.com/" target="_blank">django framework</a>. MySQL was chosen as the main database. <a href="http://redis.io/" target="_blank">Redis</a> is used as a support key-value storage for it\'s simplicity and pub/sub functional. To achieve seamless client/server interaction <a href="http://socket.io/" target="_blank">SocketIO</a> was used. <a href="http://gunicorn.org/" target="_blank">Gunicorn</a> with <a href="http://www.gevent.org/" target="_blank">gevent</a> are backing up socketio on the server side, while jQuery simplifies most user actions. One of the <a href="http://en.wikipedia.org/wiki/Shortest_path_problem" target="_blank">Shortest path algorithms</a> was utilized in this project. Lionface is hosted on Amazon EC2 and uses <a href="http://aws.amazon.com/rds/" target="_blank">RDS</a> as database storage.</p>',
